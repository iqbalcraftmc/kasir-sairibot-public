...
1. Kunjungi halaman resmi [https://api.sairibot.my.id/profile](https://api.sairibot.my.id/profile) untuk mendapatkan API Key SairiBot.
2. Kunjungi [https://iqbalcraftmc.github.io/](https://iqbalcraftmc.github.io/) untuk menghubungi saya dan mendapatkan token lisensi akses aplikasi.
...
3. Masukkan token lisensi serta API Key SairiBot pada kolom yang telah disediakan.
